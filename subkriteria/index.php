<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
        <a href="subkriteria/cetak.php" class="btn btn-<?php echo $ada_data ? 'success' : 'secondary'; ?> mb-2 <?php echo $ada_data ? '' : 'disabled'; ?>" <?php echo $ada_data ? '' : 'onclick="return false;"'; ?> target="_blank">
